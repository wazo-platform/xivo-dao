...
class CallLog(Base):
    ...
    source_internal_exten = Column(String(255))
    source_internal_context = Column(String(255))
    source_line_identity = Column(String(255))
    requested_exten = Column(String(255))
    requested_context = Column(String(255))
    requested_internal_exten = Column(String(255))
    requested_internal_context = Column(String(255))
    destination_name = Column(String(255))
    destination_exten = Column(String(255))
    destination_internal_exten = Column(String(255))
    destination_internal_context = Column(String(255))
