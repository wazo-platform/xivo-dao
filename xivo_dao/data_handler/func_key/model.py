...
class QueryHelper(object):
    ...
    destination_mapping = {
        ...
        'conf': (FuncKeyDestConfSchema, FuncKeyDestConfSchema.conf_id),
    }
    ...
    def query(self):
        ...
        return (self._session
                ...
                .outerjoin(FuncKeyDestConfSchema, FuncKeyDestConfSchema.func_key_id == FuncKeySchema.id)
