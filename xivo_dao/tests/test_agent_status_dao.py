...
class TestAgentStatusDao(DAOTestCase):
    ...
    def test_log_in_agent(self):
        ...
        assert_that(agent_status, has_properties(
            agent_id=agent_id,
    ...
    def test_get_status_by_number_with_logged_agent(self):
        ...
        assert_that(result, has_properties(
            ...
            interface=agent_login_status.interface,
            state_interface=agent_login_status.state_interface,
            queues=contains(has_properties(id=agent_membership.queue_id, name=agent_membership.queue_name)),
            user_ids=contains(user.id),
        ))
    ...
    def test_get_status_by_state_interface_with_logged_agent(self):
        ...
        result = agent_status_dao.get_status_by_state_interface(agent_login_status.state_interface)
    ...
    def test_get_statuses_to_add_to_queue(self):
        ...
        assert_that(statuses, contains(has_properties(agent_id=agent1.id, agent_number=agent1.number)))
    ...
    def test_add_agent_to_queues(self):
        ...
        assert_that(memberships, contains(
            has_properties(queue_id=queue1.id, queue_name=queue1.name, penalty=queue1.penalty),
            has_properties(queue_id=queue2.id, queue_name=queue2.name, penalty=queue2.penalty),
        ))
    ...
    def test_add_agent_to_queue_two_agents(self):
        ...
        assert_that(agent1_status, has_properties(
            queues=contains(
        ...
        assert_that(agent2_status, has_properties(
            queues=contains(
                has_properties(id=1, name='queue1'),
                has_properties(id=2, name='queue2'),
            )
    ...
    def test_update_pause_status(self):
        ...
        assert_that(agent_status, has_properties(
            agent_id=agent.id, paused=True, paused_reason=reason,
        ))
        ...
        assert_that(agent_status, has_properties(agent_id=agent.id, paused=True, paused_reason=None))
