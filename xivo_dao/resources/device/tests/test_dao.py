...
class TestDeviceDaoGetFind(TestDeviceDao):
    ...
    @patch('xivo_dao.resources.device.provd_converter.to_model')
    @patch('xivo_dao.resources.device.dao.fetch_device_and_config')
...
class TestDeviceDaoFindAll(TestDeviceDao):
    ...
    @patch('xivo_dao.resources.device.dao.find_devices_ordered')
    @patch('xivo_dao.resources.device.dao.filter_list')
    @patch('xivo_dao.resources.device.dao.paginate_devices')
    @patch('xivo_dao.resources.device.dao.convert_devices_to_model')
