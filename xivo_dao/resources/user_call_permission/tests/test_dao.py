...
class TestFindAllBy(DAOTestCase):
    ...
    def test_find_all_by_user_id_two_user_call_permissions(self):
        ...
        self.add_user_call_permission(
            user_id=user.id, call_permission_id=call_permission1.id
        )
        self.add_user_call_permission(
            user_id=user.id, call_permission_id=call_permission2.id
        )
    ...
    def test_find_all_by_call_permission_id_two_user_call_permissions(self):
        ...
        user2 = self.add_user()
        self.add_user_call_permission(
            user_id=user1.id, call_permission_id=call_permission.id
        )
        self.add_user_call_permission(
            user_id=user2.id, call_permission_id=call_permission.id
        )
    ...
    def test_find_all_by_user_id_call_permission_id_two_user_call_permissions(self):
        ...
        result = user_call_permission_dao.find_all_by(
            call_permission_id=call_permission.id, user_id=user1.id
        )
    ...
    def test_find_all_by_when_group_associate_to_call_permission(self):
        ...
        self.add_group_call_permission(
            typeval=group.id, call_permission_id=call_permission.id
        )
...
class TestDissociate(DAOTestCase):
    def test_dissociate_user_call_permission(self):
        ...
        result = (
            self.session.query(UserCallPermission)
