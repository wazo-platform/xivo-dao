...
class TestSearchGivenMultipleUsers(TestSearch):
    ...
    def test_when_searching_with_an_extra_argument(self):
        ...
        self.assert_search_collated_returns_result(expected_resto, search='ou', description='resto')

        expected_bar = SearchResult(1, [self.user3])
        self.assert_search_returns_result(expected_bar, search='ou', description='bar')
        self.assert_search_collated_returns_result(expected_bar, search='ou', description='bar')
    ...
    def test_when_doing_a_paginated_search_then_returns_a_paginated_result(self):
        ...
        self.assert_search_returns_result(expected,
                                          ...
                                          offset=1,
                                          limit=1)
        self.assert_search_collated_returns_result(expected,
                                          search='a',
                                          order='firstname',
                                          direction='desc',
                                          offset=1,
