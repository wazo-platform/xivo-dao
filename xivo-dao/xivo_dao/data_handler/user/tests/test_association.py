...
class TestUserAssociation(unittest.TestCase):
    ...
    @patch('xivo_dao.data_handler.line.services.get')
    @patch('xivo_dao.data_handler.user.services.get')
    def test_associate_user_line_extension_with_user_line_already_associated(self,
                                                                             get_user,
                                                                             get_line,
                                                                             get_extension,
                                                                             create_extension,
        ...
        self.assertEquals(line_associate_extension.call_count, 0)
        self.assertEquals(extension_dao_edit.call_count, 0)
    ...
    @patch('xivo_dao.data_handler.line.services.get')
    @patch('xivo_dao.data_handler.user.services.get')
    def test_associate_user_line_extension(self, get_user, get_line, get_extension, create_ule, line_associate_extension, extension_dao_edit):
        user_id = 21
        line_id = 32
        extension_id = 1220
        exten = '42'
